 ...
 */
public class seis extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Nit  Clientes:");

        jLabel3.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Direccion  Clientes:");

        jLabel2.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Nombre  Clientes:");

        jLabel1.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Codigo clientes:  ");

        jLabel7.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Estatus  Clientes:");
        ...
        jLabel13.setText("Ingrese el codigo de Clientes:");

        jLabel5.setBackground(new java.awt.Color(255, 255, 255));
        jLabel5.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Mantenimientos de Clientes");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (rs.next()) {
                txt_1.setText(rs.getString("codigo_cliente"));
                txt_2.setText(rs.getString("nombre_cliente"));
                txt_3.setText(rs.getString("direccion_cliente"));
                txt_4.setText(rs.getString("telefono_cliente"));
                txt_5.setText(rs.getString("nit_clienter"));
                txt_6.setText(rs.getString("estatus_cliente"));
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        try {
            ...
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/final", "root", "");
            PreparedStatement pst = cn.prepareStatement("update clientes set codigo_cliente = ?, nombre_cliente = ?, direccion_cliente = ?, telefono_cliente = ?, nit_clienter = ?, estatus_cliente = ? where ID = " + ID);
